...
namespace Invenire.Api.Organizations.Invitations.CreateFromJsonFile;

public class CreateFromJsonFileOrganizationInvitationResponse
{
    ...
    [
        ...
        new ErrorTranslation
        {
            ...
            Translate = _ => "Formát souboru je nesprávný. Ujistěte se, že soubor obsahuje platné JSON pozvánky."
        },
